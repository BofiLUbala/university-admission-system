  ...
  return (
    <div className="container mx-auto px-4 lg:px-8 py-24 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-ulk-blue mb-8">About Université Libre de Kinshasa</h1>
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-neutral-100 prose max-w-none">
          <p className="text-lg text-neutral-600 mb-6">
            The Université Libre de Kinshasa (ULK) is one of the premier higher education institutions in the Democratic Republic of Congo. Founded with the mission to provide accessible, high-quality education, ULK has grown into a vibrant center of learning and research.
          </p>
